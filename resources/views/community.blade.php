...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css" integrity="sha512-YQo8S7JEw0z49fU+58GViD5Kgb4b8NEU4cqAJF4YLJG5ZdZ4E5JCSLZqoYEdRMk0cz2slGhUHiX+2V1dcN2cXA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
        ...
        <meta property="og:site_name" content="Mirrash"/>
        ...
        <link rel="search" type="application/opensearchdescription+xml" href="{{ route('welcome') }}" title="Mirrash"/>
                            ...
                            <div class="entry-content">
                                ...
                                <div class="wp-block-columns alignwide has-3-columns is-layout-flex wp-container-core-columns-is-layout-1 wp-block-columns-is-layout-flex" style="display: flex; flex-wrap: wrap;">
                                    @foreach($communities as $community)
                                        <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow" style="flex: 1 1 calc(33.333% - 20px); margin-left: 20px; margin-right: 20px; box-sizing: border-box;">
                                            <div class="wp-block-image" style="position: relative;">
                                                <figure class="aligncenter size-large" style="position: relative; width: auto;">
                                                    <img src="{{ $community->photo }}" alt="{{ $community->beneficiary }}" class="wp-image" style="max-width: 100%; height: auto;"/>
                                                </figure>
                                            </div>
                                            <h2 class="has-text-align-left wp-block-heading">{{ $community->beneficiary }}</h2>
                                            <p class="has-small-font-size"><strong>Razón:</strong> {{ $community->reason }}</p>
                                            <p class="has-small-font-size"><strong>Inicio de la promoción:</strong> {{ $community->date_one }}</p>
                                            <p class="has-small-font-size"><strong>Fin de la promoción:</strong> {{ $community->date_two }}</p>
                                            <p class="has-small-font-size"><strong>Regalo:</strong> {{ $community->gift }}</p>
                                            <div style="display: flex; justify-content: center; gap: 25px; margin-top: 20px;">
                                                <a href="https://api.whatsapp.com/send?phone=7224958550&amp;text=Me%20gustaría%20saber%20más%20sobre%20{{ $community->beneficiary }}" class="button" style="display: flex; align-items: center; background-color:#59bb40; color: white;">
